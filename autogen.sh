...
echo "AC_DEFUN([SST_FORZASIM_MACRO_CONFIG_OUTPUT], [])" > config/sst_forzasim_macro_config_output.m4
echo "dnl Automatically generated by SST configuration system" > config/sst_forzasim_macro_include.m4
...
if test ! -d src/libltdl ; then
    echo "libltdl for forzasim_macro exist.  Aborting."
    exit 1
fi
